        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <a href="mailto:president@xploits.edu" className="flex items-center space-x-2 text-gray-400 hover:text-primary transition-colors">
                <Mail size={18} />
                <span>Xploits2k25@gmail.com</span>
              </a>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start space-x-2 text-gray-400">
              ...
              <p>National Highway 45, Potheri, SRM Nagar, Kattankulathur, Tamil Nadu 603203</p>
            </div>
          </div>
          
          <div className="space-y-4">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3890.268102623864!2d80.03873787507392!3d12.82594418747622!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a52f70d79722631%3A0x49afcd4648f94894!2sSRM%20Valliammai%20Engineering%20College!5e0!3m2!1sen!2sin!4v1737346612957!5m2!1sen!2sin"
